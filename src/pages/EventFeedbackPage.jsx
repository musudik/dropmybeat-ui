...
const EventFeedbackPage = () => {
  ...
  const handleModerationAction = async (feedbackId, action) => {
    try {
      ...
      const message =
        error.response?.data?.message || `Failed to ${action} feedback`;
      toast.error(message);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-black text-white font-roboto">
            ...
            <CardContent className="p-6">
              <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="flex-1">
                  ...
                  {!event.bannerImageUrl && (
                    <h2 className="text-2xl font-bold mb-2 font-oswald">
                      {event.name}
                    </h2>
                  )}
      ...
      <Dialog
        open={!!selectedFeedback && !!moderationAction}
        onOpenChange={() => {
          setSelectedFeedback(null);
          setModerationAction(null);
        }}
        ...
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              onClick={() =>
                handleModerationAction(selectedFeedback.id, moderationAction)
              }
            >
